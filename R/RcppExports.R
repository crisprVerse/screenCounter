...
count_combo_barcodes <- function(path, constant, strand, options, mismatches, use_first, nthreads) {
    .Call('_screenCounter_count_combo_barcodes', PACKAGE = 'screenCounter', path, constant, strand, options, mismatches, use_first, nthreads)
}
